...
The steady state solution can be found easily by solving the laplace eqation wich are the harmonic solution. So we have to write our problem on 
a form that is easier to solve. So we introduce:
...
In two dimensions we only look for at the steady state solution with the boundary conditions:
...
\end{equation}
Setting htis into the steady steady state solution
